...
- *What is the protocol fee?* AiFinPay adds 1% on top of the merchant amount; the configured merchant amount settles in full, excluding applicable network or settlement costs.
