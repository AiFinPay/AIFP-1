...
// Charges the Standard action tier ($0.0005) for /api/data.
...
```http
GET /api/data                          -> 402 + AIFP challenge (qt url, nonce, $0.0005)
...
# -> 402 detected, quoted Standard at $0.0005, paid, receipt rcpt_..., got payload
```
