...
| Tier | Fixed Price Per Action | Typical Action |
|---|---:|---|
...
1. **Identical pricing & enums** — fixed action pricing tiers (Standard $0.0005, Complex $0.002, Premium $0.005), assets (USDC/USDT/PYUSD), and the supported network set are the same everywhere.
